 ...
 *==============================================================================
 */
public class CateAndroidAdapter extends RecyclerView.Adapter<CateAndroidAdapter.ViewHolder> {
    ...
    @Override
    public CateAndroidAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_adapter_item_two, parent, false);
        CateAndroidAdapter.ViewHolder vh = new CateAndroidAdapter.ViewHolder(view);
        return vh;
    }

    @Override
    public void onBindViewHolder(CateAndroidAdapter.ViewHolder holder, final int position) {
