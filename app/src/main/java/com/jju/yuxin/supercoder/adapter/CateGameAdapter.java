 ...
 * ClassName CateGameAdapter
 * Created by yuxin.
 * Created time 13-12-2016 15:13.
 * Describe : 游戏 fragment 没有添加广告控件
 * History:
 * Version   1.0.
 *
 *==============================================================================
 */
public class CateGameAdapter extends RecyclerView.Adapter<CateGameAdapter.ViewHolder> {


    private static final String TAG = CateGameAdapter.class.getSimpleName();

    private Context context;
    //里面的数据
    private List<NewslistBean> newslistBeen = new ArrayList<>();

    public CateGameAdapter(Context context) {
    ...
    @Override
    public CateGameAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //返回ViewHolder
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_adapter_item_two, parent, false);
        CateGameAdapter.ViewHolder vh = new CateGameAdapter.ViewHolder(view);
        return vh;
    }

    @Override
    public void onBindViewHolder(CateGameAdapter.ViewHolder holder, final int position) {
        //图片加载失败
