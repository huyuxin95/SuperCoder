 ...
 * ==============================================================================
 */
public class CateIOSAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static String TAG = CateIOSAdapter.class.getSimpleName();
     ...
     * @param context
     */
    public CateIOSAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_TYPE.NEW.ordinal()) {
            //新闻布局
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_adapter_item_ios, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            ry_cardview = (LinearLayout) view.findViewById(R.id.ry_cardview_ios);
