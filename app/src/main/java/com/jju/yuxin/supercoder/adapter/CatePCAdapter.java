 ...
 * ClassName CatePCAdapter
 * Created by yuxin.
 * Created time 13-12-2016 15:13.
 * Describe : PC fragment 没有添加广告控件
 * History:
 * Version   1.0.
 *
 *==============================================================================
 */
public class CatePCAdapter extends RecyclerView.Adapter<CatePCAdapter.ViewHolder> {


    private static final String TAG = CatePCAdapter.class.getSimpleName();
    ...
    @Override
    public CatePCAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
     //返回ViewHolder
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_adapter_item_two, parent, false);
        CatePCAdapter.ViewHolder vh = new CatePCAdapter.ViewHolder(view);
        return vh;
    }

    @Override
    public void onBindViewHolder(CatePCAdapter.ViewHolder holder, final int position) {
     //图片加载失败
