 ...
 * ClassName ChuangyeAdapter
 * Created by yuxin.
 * Created time 12-12-2016 14:13.
 * Describe :  创业页面的Fragment适配器
 * History:
 * Version   1.0.
 *
 *==============================================================================
 */
public class ChuangyeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG=ChuangyeAdapter.class.getSimpleName();
    //上下文
