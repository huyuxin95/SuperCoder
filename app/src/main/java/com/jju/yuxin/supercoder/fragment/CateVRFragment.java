...
import com.jju.yuxin.supercoder.adapter.CateVRAdapter;
 ...
 *==============================================================================
 */
public class CateVRFragment extends ScrollAbleFragment {

    private static final String TAG =CateVRFragment.class.getSimpleName();
    private YRecycleview recyclerview;
    private CateVRAdapter vrAdapter;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Constant.FINISHED:
                    ...
                    vrAdapter.onReference(newslistBeen);
                    break;
                case Constant.LOADMORE:
                    ...
                    vrAdapter.addOnReference(addlistBean);
                    break;
                case Constant.ERROR:
                    break;
                default:
     ...
     * @return
     */
    public static CateVRFragment newInstance(){
        CateVRFragment fragment = new CateVRFragment();
        Bundle bundle = new Bundle();
        bundle.putString("fragment",CateVRFragment.class.getSimpleName());
        return fragment;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //内容的适配器
        vrAdapter = new CateVRAdapter(getActivity());
        recyclerview.setAdapter(vrAdapter);

        //Item点击事件
        vrAdapter.setOnItemClickLitener(new CateVRAdapter.OnItemClickLitener() {
            @Override
        ...
        params_map.addToParams_map("word","VR");
        //获取网络数据
        ...
        recyclerview.setRefreshAndLoadMoreListener(new YRecycleview.OnRefreshAndLoadMoreListener() {
            ...
            public void onLoadMore() {
                ...
                int page= (vrAdapter.getItemCount())/Constant.DEFAULT_COUNT+1;
