...
import com.jju.yuxin.supercoder.view.tablayout.listener.OnTabSelectListener;
import com.jju.yuxin.supercoder.view.tablayout.utils.UnreadMsgUtils;
import com.jju.yuxin.supercoder.view.tablayout.widget.MsgView;
 ...
 *=============================================================================
 *
 * Copyright (c) 2016  flyco rights reserved.
 * ClassName SlidingTabLayout
 * Created by flyco.
 * Created time
 * Describe :滑动TabLayout,对于ViewPager的依赖性强
 * History:
 * Version   1.0.
 *
 *==============================================================================
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        if (mTabSpaceEqual || mTabWidth > 0) {
            ...
            mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, dp2px(20));
        }
        ta.recycle();
    }
